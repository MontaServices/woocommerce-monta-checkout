...
#1.58.63
* Fixed google call when coordinates are 0,0
...
#1.58.60
* Revert "Fix issue with packages being invalid" (errors on some versions)

#1.58.59
* Fix issue with packages being invalid

#1.58.58
* Show Standard shipper when no other shipper is available

#1.58.57
* Fix virtual products with Variations
...
* Fix Shipping costs not updating properly
